...
class TicTacToeDisplay(Display):
    ...
    def start_menu(self, game):
        ...
        in_game_title_image = Image.open(self.IMAGES+"title.png")
        ...
        in_game_title_image = self.image_converter.scale_image(in_game_title_image, 300)
        ...
        self.ascii_in_game_title = self.image_converter.image_to_ascii(in_game_title_image)
        ...
        self.board = {
                    game.game_board.EMPTY:self.ascii_empty,
                    game.game_board.O:self.ascii_o,
                    game.game_board.X:self.ascii_x
                        }    
        print(self.ascii_title)
        #print(self.ascii_in_game_title)
